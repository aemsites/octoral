...
export default {
    ...
    preprocess: ({
        ...
        if (newsArticle) {
            ...
            fields.newsImgAltText = newsArticle.querySelector('.entry-content img')?.getAttribute('alt');
    ...
    transformDOM: ({
        ...
        const temp = document.querySelector('.block-newsarticle section article');
        const cells = [
            ['news'],
            [temp]
        ]
        const table = WebImporter.DOMUtils.createTable(cells, document);
        document.querySelector('.block-newsarticle').replaceWith(table);
        return main;
    },
